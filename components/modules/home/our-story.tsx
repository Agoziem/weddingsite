...
const OurStorySection = () => {
  ...
  return (
    <section ref={ref} id="our-story" className="py-16 bg-background text-foreground relative overflow-hidden">
      ...
      <div className="m-auto max-w-7xl px-6 py-10 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start mt-12">
          ...
          >
            <div className="text-lg sm:text-xl font-semibold text-muted-foreground">Our Love story so far</div>
            <div
          ...
          <div className="grid grid-cols-2 gap-4 h-[400px] sm:h-[450px] md:h-[400px]">
